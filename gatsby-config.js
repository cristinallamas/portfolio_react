module.exports = {
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        name: `bio`,
        path: `${__dirname}/src/data/about.json`,
      },
    },
    {
      resolve: `gatsby-source-filesystem`,
    ...
    },
    {
      ...
      options: {
        name: `work`,
        path: `${__dirname}/src/data/work.json`,
      },
    },
    `gatsby-transformer-pdf`,
    {
      resolve: `gatsby-source-filesystem`,
      options: {
        path: `${__dirname}/src/blog_content/blog`,
        name: `blog`,
      },
    },
    {
      resolve: `gatsby-source-filesystem`,
      options: {
        path: `${__dirname}/src/blog_content/assets`,
        name: `assets`,
      },
    },
    ...
    },
    {
      ...
      options: {
        ...
        cookieDomain: 'cristinallamas.dev',
      },
    },
  ],
};
